...
export const metadata: Metadata = {
  title: "Magister Ministri — Marketplace (M.Min.) — STTB Bandung",
  description:
    "Program Magister Ministri Marketplace STTB untuk memperlengkapi profesional, wirausahawan, dan pemimpin gereja dengan landasan Teologi Reformed dalam mengintegrasikan iman dan pekerjaan. 54 SKS, kelas akhir pekan, gelar M.Min.",
};
...
const REQUIREMENTS = [
  ...
  "Pernah terlibat pelayanan di gereja/lembaga pelayanan minimal 1 tahun.",
  "Menyerahkan book review.",
  "Memenuhi syarat dan prosedur admisi STTB.",
];

const SYSTEM_ITEMS = [
  "Perkuliahan dilakukan pada akhir pekan. Satu akhir pekan senilai 1 SKS.",
...
const CURRICULUM_CATEGORIES = [
  {
    ...
    sks: "9 SKS",
    description: "PL, PB, Hermeneutika",
  },
  {
    title: "Sistematika - Historika",
    sks: "12 SKS",
  ...
  },
  {
    ...
    sks: "12 SKS",
    description: "Spiritualitas, Pemuridan, Misi, & Kepemimpinan Dunia Kerja",
  },
  {
    title: "Konsentrasi",
    sks: "6 SKS",
    description: "Teologi & Etika Kerja",
  },
  {
    title: "Mata Kuliah Elektif",
    sks: "6 SKS",
    description: "Isu Kontemporer, Kesehatan Mental, Konseling, dll.",
  },
  {
    title: "Tugas Akhir & Mentoring",
    sks: "9 SKS",
    description: "Mentoring Profesi & Proyek Tugas Akhir",
  },
];
    ...
    <main>
      ...
      <section className="relative overflow-hidden">
        <div className="grid lg:grid-cols-2 min-h-[92vh]">
          ...
          <div className="relative min-h-[400px] overflow-hidden">
            <Image
              src="/images/Akademik/Magister-Minister-marketplace.png"
              alt="Magister Ministri Marketplace STTB"
              fill
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <div
                ...
                style={{ background: "#E8F0FB" }}
              >
                <Briefcase className="w-7 h-7" style={{ color: "#0056B3" }} />
              </div>
              <h3
                className="mb-4 font-heading"
                style={{ fontSize: "24px", fontWeight: 700, color: "#00276B" }}
      ...
      >
        <div className="max-w-[1280px] mx-auto px-6 lg:px-16">
          ...
          <div className="mt-12 text-center">
            ...
            >
              *Total beban studi keseluruhan adalah 54 SKS
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-16">
          ...
          <MagisterMinistriMarketplaceAccordion />
        </div>
      </section>
      ...
      <section className="py-20 lg:py-24" style={{ background: "#F8F7F4" }}>
        <div className="max-w-[1280px] mx-auto px-6 lg:px-16 text-center">
          ...
          >
            Hadirkan Shalom Melalui Pekerjaan Anda
          </h2>
          <p
