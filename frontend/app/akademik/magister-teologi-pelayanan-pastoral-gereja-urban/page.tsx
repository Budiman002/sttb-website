...
export const metadata: Metadata = {
  title: "Magister Teologi — Pelayanan Pastoral Gereja Urban (M.Th.) — STTB Bandung",
  description:
...
const CURRICULUM_CATEGORIES = [
  {
    ...
    sks: "15 SKS",
    description: "Peran Gereja, Gereja Perkotaan, Misi, Sejarah, & Spiritualitas",
  },
  {
    title: "Konsentrasi",
    sks: "18 SKS",
            ...
            <div className="max-w-2xl">
              ...
              <h1 className="mb-8">
                ...
                <span
                  ...
                  style={{ fontSize: "clamp(32px, 5.5vw, 68px)", fontWeight: 700, lineHeight: 1.05 }}
                >
              ...
              >
                Program studi ini ditujukan untuk memperlengkapi rohaniwan dengan
                landasan Teologi Reformed untuk menerapkan misi yang integral dalam
                pelayanan pastoral mereka di tengah kompleksitas konteks gereja
                perkotaan.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="font-body" style={{ fontSize: "16px", color: "#6B7A99", lineHeight: 1.7 }}>
                ...
                relevansinya dalam konteks perkotaan.
              </p>
            </div>
            ...
            >
              ...
              <p className="font-body" style={{ fontSize: "16px", color: "#6B7A99", lineHeight: 1.7 }}>
                <em>Pastor-scholar</em> yang hidupnya mengalami transformasi nyata
                dan berpusatkan kepada Kristus dalam setiap aspek kehidupannya.
              </p>
            </div>
            ...
            >
              ...
              <p className="font-body" style={{ fontSize: "16px", color: "#6B7A99", lineHeight: 1.7 }}>
                ...
                yang integral dalam konteks gereja perkotaan.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="max-w-[1280px] mx-auto px-6 lg:px-16">
          ...
          <div className="mt-12 text-center">
            ...
            >
              *Total beban studi M.Th keseluruhan adalah 56 SKS (Di luar kelas matrikulasi bagi lulusan S1 non-teologi)
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1280px] mx-auto px-6 lg:px-16">
          <div className="text-center mb-16">
            ...
            >
              ...
              kompetensi Anda sebagai Pastor-Scholar di gereja urban.
            </p>
          </div>
      ...
      <section className="py-20 lg:py-24" style={{ background: "#F8F7F4" }}>
        <div className="max-w-[1280px] mx-auto px-6 lg:px-16 text-center">
          ...
          >
            ...
            <em>Pastor-Scholar</em> yang transformatif di tengah kompleksitas kota.
          </p>
